...
p1_v = [-1, 3]
p1_u = [0, 4]
p1_v_plus_u = [-1,7] # [x+y for (x,y) in zip(p1_v,p1_u)]
p1_v_minus_u = [-1,-1] # [x-y for (x,y) in zip(p1_v,p1_u)]
p1_three_v_minus_two_u = [-3,1] # [3*x-2*y for (x,y) in zip(p1_v,p1_u)]
...
p2_u = [-1,  1, 1]
p2_v = [ 2, -1, 5]
p2_v_plus_u = [1,0,6] # [x+y for (x,y) in zip(p2_v,p2_u)]
p2_v_minus_u = [3,-2,4] # [x-y for (x,y) in zip(p2_v,p2_u)]
