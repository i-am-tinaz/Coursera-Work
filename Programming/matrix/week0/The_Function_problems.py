...
comprehension_with_row = [row(u,20) for u in list(range(15))] 

comprehension_without_row = [[u+i for i in list(range(20))] for u in list(range(15))]
